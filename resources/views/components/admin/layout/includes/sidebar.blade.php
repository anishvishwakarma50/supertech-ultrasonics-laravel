  ...
  <ul class="nav">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="man-inr">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="add-industry.php">Add Industry</a></li>
          <li class="nav-item"> <a class="nav-link" href="manage_industries.php">Manage Industries</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
      <a class="nav-link" href="import-invoice.php">
        <i class="icon-grid menu-icon"></i>
