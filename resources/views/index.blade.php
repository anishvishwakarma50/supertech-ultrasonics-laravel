                    ...
                    <div id="rs_slider_02" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.7">
                        <ul>
                            ...
                            <li data-index="rs-02" data-transition="random" data-slotamount="default" data-hideafterloop="0"
                                data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default"
                                data-thumb="assets/img/slider/slider02.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide"
                                data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7=""
                                data-param8="" data-param9="" data-param10="" data-description="">
                                <!-- MAIN IMAGE -->
                                <img src="assets/img/slider/slider02.jpg" alt="" data-bgposition="center center" data-bgfit="cover"
                                    data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                                <!-- LAYERS -->
                                ...
                                <div class="tp-caption rev_group" id="rs-layer-01-1" data-x="['left','left','left','left']"
                                    ...
                                    <div class="tp-caption NotGeneric-Title  tp-resizeme" id="rs-layer-02-1" data-x="['left','left','left','left']"
                                        ...
                                        data-marginleft="[0,0,0,0]" data-textAlign="['inherit','inherit','inherit','inherit']"
                                        data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                                        data-paddingleft="[0,0,0,0]" data-fontsize="['75', '60', '50', '40']"
                                        data-lineheight="['85', '80', '65', '50']"
                                        style="z-index: 7;white-space: normal; font-size: 75px; line-height: 60px; font-weight: 700; color: #fff; letter-spacing: 0px;font-family:'Roboto', sans-serif;">
                                        Buildmart Costruction
                                        Industrial Company
                                    </div>
                                    <!-- LAYER NR. 3 -->
                                </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="features-wrapper mb-30">
                                <div class="features-img">
                                    <img src="assets/img/features/02.jpg" alt="">
                                    <div class="features-text">
                                        <h3><a href="#">Construction Service</a></h3>
                                        <a href="#">learn more <i class="far fa-long-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="features-wrapper mb-30">
                                <div class="features-img">
                                    ...
                                    <div class="features-text">
                                        <h3><a href="#">Chemical Services</a></h3>
                                        <a href="#">learn more <i class="far fa-long-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-8 offset-xl-2">
                            ...
                            <div class="testimonia-item-active test-3-dot">
                                <div class="testimonial-item text-center">
                                    <p>Sed ut perspiciatis unde omnis iste natus error volutem accusantiu
                                    doloremque laudante totam rem aperiam eaque ipsa quaetas site must explain to you how alls this mistak denouncing</p>
                                ...
                                <div class="testimonial-item text-center">
                                    <p>Sed ut perspiciatis unde omnis iste natus error volutem accusantiu
                                        doloremque laudante totam rem aperiam eaque ipsa quaetas site must explain to you how alls this mistak denouncing
                                    </p>
                                        <div class="designation mb-30">
                                            <h3>Masud Hassan</h3>
                                            <span>Designer</span>
